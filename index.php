...
<body>
    ...
    <p id="cookieForm" class="cookieForm" style="color:whitesmoke; text-shadow:0px 0px 10px rgba(123,102,255)">Message bien envoyé !</p>
    <?php
        }
    ?>
    <?php
    ...
    <section id="section_2">
        ...
        <p>&ensp; &ensp; &ensp; &ensp;Durant mon parcours scolaire, j’ai eu l’opportunité de découvrir de nombreux secteurs d’activité (Commerce, Marketing, Comptabilité, Gestion…). Nonobstant, c’est en travaillant en autodidacte que j’ai construit mon attrait tout particulier pour l’informatique, principalement le développement web et la conception de jeux/applications. Depuis le 7 Mars 2022, j’ai intégré la formation « Access Code School : Développeur Web et Web Mobile » où j’ai eu l’opportunité de développer mes connaissances en informatique. Effectivement, par de nombreux projets j’ai pu approfondir et acquérir de nouvelles compétences dans les langages de programmation : HTML, CSS, JavaScript, PHP ainsi que d’autres outils impérieux pour le développement web : Git, GitHub, Laragon, Bootstrap, etc.</p>
